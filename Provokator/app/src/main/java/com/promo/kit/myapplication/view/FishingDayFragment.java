...
public class FishingDayFragment extends DialogFragment {

    private PagerSlidingTabStrip tabs;
    private ViewPager pager;
    private ContactPagerAdapter adapter;

    public static FishingDayFragment newInstance() {
        FishingDayFragment f = new FishingDayFragment();
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fish, container, false);

        tabs = (PagerSlidingTabStrip) root.findViewById(R.id.tabs);
        pager = (ViewPager) root.findViewById(R.id.container);
    ...
    public class ContactPagerAdapter extends PagerAdapter implements IconTabProvider {
        ...
        private final int[] ICONS = { R.drawable.ic_launcher, R.drawable.ic_launcher_actionbar,
                R.drawable.ic_launcher, R.drawable.ic_launcher_actionbar};
